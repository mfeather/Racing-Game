...
namespace _RacingGame
{
    public class Terrain
    {
        ...
        public Terrain(Texture2D HeightMap, float CellSize, float Height,
            ...
            GraphicsDevice GraphicsDevice, ContentManager Content, Effect Effect)
        {
        ...
        private void createVertices()
        {
            ...
            // Calculate the position offset that will center the terrain at zero
            ...
            for (int z = 0; z < length; z++)
                for (int x = 0; x < width; x++)
                {
                    ...
                    Vector2 uv = new Vector2((float)x / width * textureTiling, (float)z / length * textureTiling);
                    // Create the vertex
        ...
        public void Draw(GraphicsDevice device, Matrix view, Matrix projection)
        {
            ...
            effect.Parameters["xColorTexture"].SetValue(baseTexture);
            ...
            foreach (EffectPass pass in effect.CurrentTechnique.Passes)
            {
                ...
                device.DrawIndexedPrimitives(PrimitiveType.TriangleList,
                            0, 0, vertices.Length, 0, indices.Length / 3);
            }
